...
**最新版本**: `v2.1.150` · [下载](https://github.com/zcimon57-svj/claude-code-offline/releases/latest) · [详细安装步骤](INSTALL.md)
...
```bash
curl -fsSLO https://github.com/zcimon57-svj/claude-code-offline/releases/download/v2.1.150/claude-code-offline-2.1.150-linux-x64.tar.gz
tar -xzf claude-code-offline-2.1.150-linux-x64.tar.gz
cd claude-code-offline-2.1.150-linux-x64
./install.sh
claude --version
```
...
```powershell
Invoke-WebRequest -Uri https://github.com/zcimon57-svj/claude-code-offline/releases/download/v2.1.150/claude-code-offline-2.1.150-win32-x64.zip -OutFile claude-code-offline-2.1.150-win32-x64.zip
Expand-Archive claude-code-offline-2.1.150-win32-x64.zip
cd claude-code-offline-2.1.150-win32-x64
...
# 锁定版本
VERSION=2.1.150 PLATFORM=win32-x64 GH_REPO=zcimon57-svj/claude-code-offline GH_TOKEN=ghp_xxx ./pack-claude-code.sh ./out --push
