...
**最新版本**: `v2.1.186` · [下载](https://github.com/zcimon57-svj/claude-code-offline/releases/latest) · [详细安装步骤](INSTALL.md)
...
tar -xzf claude-code-offline-2.1.186-linux-arm64.tar.gz
cd claude-code-offline-2.1.186-linux-arm64
./install.sh
claude --version
```
...
# 锁定版本
VERSION=2.1.186 PLATFORM=win32-x64 GH_REPO=zcimon57-svj/claude-code-offline GH_TOKEN=ghp_xxx ./pack-claude-code.sh ./out --push
