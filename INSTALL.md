...
| 平台 | 包名 | 安装脚本 |
|---|---|---|
| Linux x64 | `claude-code-offline-2.1.228-linux-x64.tar.gz` | `install.sh` |
| Linux arm64 | `claude-code-offline-2.1.228-linux-arm64.tar.gz` | `install.sh` |
| Windows x64 | `claude-code-offline-2.1.228-win32-x64.zip` | `install.ps1` |
