...
| 平台 | 包名 | 安装脚本 |
|---|---|---|
| Linux x64 | `claude-code-offline-2.1.143-linux-x64.tar.gz` | `install.sh` |
| Linux arm64 | `claude-code-offline-2.1.143-linux-arm64.tar.gz` | `install.sh` |
| Windows x64 | `claude-code-offline-2.1.143-win32-x64.zip` | `install.ps1` |
...
```powershell
Invoke-WebRequest -Uri https://github.com/zcimon57-svj/claude-code-offline/releases/download/v2.1.143/claude-code-offline-2.1.143-win32-x64.zip -OutFile claude-code-offline-2.1.143-win32-x64.zip
```
...
```powershell
Expand-Archive claude-code-offline-2.1.143-win32-x64.zip
cd claude-code-offline-2.1.143-win32-x64
