...
| 平台 | 包名 | 安装脚本 |
|---|---|---|
| Linux x64 | `claude-code-offline-2.1.266-linux-x64.tar.gz` | `install.sh` |
| Linux arm64 | `claude-code-offline-2.1.266-linux-arm64.tar.gz` | `install.sh` |
| Windows x64 | `claude-code-offline-2.1.266-win32-x64.zip` | `install.ps1` |
